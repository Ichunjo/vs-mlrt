...
static std::vector<std::wstring> optionalCudaDlls{
    ...
    L"cudnn_graph64",
    L"cudnn_engines_precompiled64",
    L"cudnn_heuristic64",
    L"cudnn_engines_runtime_compiled64",
    L"cudnn_ops64",
    L"cudnn_cnn64",
    L"cudnn_adv64",
    L"cudnn_engines_tensor_ir64",
    L"cudnn_ext64",
    L"cudnn64",
    L"cupti64",
};
...
bool verbose() {
    return getenv("VSORT_VERBOSE") != nullptr;
}
